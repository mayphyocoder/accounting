        ...
        <div class="workplace">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route('cashbook.update', $cashbook->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="block-fluid table-sorting clearfix">
                            <table cellpadding="0" cellspacing="0" width="100%" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="date" name="cashbook_date"
                                                value="{{ $cashbook->cashbook_date }}" style="width: 100%;">
                                            @error('cashbook_date')
                                                {{ $message }}
                                            @enderror
                                        </td>
                                        ...
                                        <td>
                                            <select name="coa_acc_type_id_1" id="s2_1" style="width: 100%;">
                                                <option value="{{ $cashbook->coa_acc_type_id_1 }}">Please select...</option>
                                                @foreach ($chartof_accounts as $chartof_account)
                                                    <option value="{{ $chartof_account->id ?? '' }}"
                                                        @if ($chartof_account->id == $cashbook->coa_acc_type_id_1) selected @endif>
                                        ...
                                        <td>
                                            <select name="coa_acc_type_id_2" id="s2_1" style="width: 100%;">
                                                <option value="{{ $cashbook->coa_acc_type_id_2 }}">Please select...</option>
                                                @foreach ($chartof_accounts as $chartof_account)
                                                    @if ($chartof_account->account_type_id == 3 || $chartof_account->account_type_id == 4)
                                                        <option value="{{ $chartof_account->id ?? '' }}"
                                                            @if ($chartof_account->id == $cashbook->coa_acc_type_id_2) selected @endif>
                                                            {{ $chartof_account->coa_name }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                        ...
                                        <td>
                                            <input type="text" placeholder="Voucher" value="{{ $cashbook->voucher }}"
                                        ...
                                        <td>
                                            <input type="text" value="{{ $cashbook->debit }}" style="width: 100%;"
                                                name="debit" oninput="calc()" id="debit" />
                                            @error('debit')
                                                {{ $message }}
                                            @enderror
                                        </td>
                                        ...
                                        <td>
                                            <input type="text" value="{{ $cashbook->credit }}" style="width: 100%;"
                                                name="credit" oninput="calc()" id="credit" />
                                            @error('credit')
                                                {{ $message }}
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <input type="text" placeholder="Description" style="width: 100%;"
                                                ...
                                                value="{{ $cashbook->cashbook_description }}" />
                                        ...
                                        <td>
                                            <select name="currency" value="{{ $cashbook->currency }}"
                                                style="width: 100%;">
                                        ...
                                        <td>
                                            <input type="text" value="{{ $cashbook->rate }}" placeholder="Rate"
                                                style="width: 100%;" name="rate" oninput="calc()" id="rate" />
                                            @error('rate')
                                                {{ $message }}
                                            @enderror
                                        </td>
