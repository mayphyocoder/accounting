...
<html lang="en">
    <head>        
        ...
        <script type='text/javascript' src="{{asset('assets/js/plugins/maskedinput/jquery.maskedinput-1.3.min.js')}}"></script>
        
        <script type='text/javascript' src="{{asset('assets/js/plugins/validation/languages/jquery.validationEngine-en.js')}}" charset='utf-8'></script>
        <script type='text/javascript' src="{{asset('assets/js/plugins/validation/jquery.validationEngine.js')}}" charset='utf-8'></script>
        
        <script type='text/javascript' src="{{asset('assets/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js')}}"></script>
        <script type='text/javascript' src="{{asset('assets/js/plugins/animatedprogressbar/animated_progressbar.js')}}"></script>
...
<body>
    <div class="wrapper"> 
        ...
        <div class="header">
            <a class="logo" href="index.html"><img src="{{asset('assets/img/logo.png')}}" alt="Aquarius -  responsive admin panel" title="Aquarius -  responsive admin panel"/></a>
