                    ...
                    <form action="{{ route('classification.update', $classification->id) }}" method="post">
                        ...
                        <div class="block-fluid">
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="col-md-9"><input type="text" value="{{ $classification->account_name }}"
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="col-md-9"><input type="text" value="{{ $classification->account_code }}"
                                        placeholder="Account Code" name="account_code" />
                                    @error('account_code')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
